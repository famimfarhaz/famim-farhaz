    ...
    <div className="space-y-2 relative">
      ...
      <div className="relative">
        ...
        >
          ...
          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-200 ${dropdownStates[dropdownName] ? 'rotate-180' : ''
            }`} />
        </div>
                ...
                <Card className="p-8 lg:p-10 bg-card border-border shadow-xl">
                  ...
                  <div className="flex items-center mb-8">
                    <div className="flex items-center space-x-4">
                      <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all duration-300 ${currentStep >= 1 ? 'bg-accent text-accent-foreground step-glow' : 'bg-muted text-muted-foreground'
                        }`}>
                        {currentStep >= 1 ? (
                          <CheckCircle2 className="h-4 w-4" />
                        ) : (
                      ...
                      <div className={`h-px w-16 transition-all duration-500 relative overflow-hidden ${currentStep >= 2 ? 'bg-accent' : 'bg-border'
                        }`}>
                        {currentStep >= 2 && (
                          <div className="absolute top-0 left-0 h-full bg-accent progress-fill" />
                        )}
                      </div>
                      <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all duration-300 ${currentStep >= 2 ? 'bg-accent text-accent-foreground step-glow' : 'bg-muted text-muted-foreground'
                      ...
                      <div className={`h-px w-16 transition-all duration-500 relative overflow-hidden ${currentStep >= 3 ? 'bg-accent' : 'bg-border'
                        }`}>
                        {currentStep >= 3 && (
                          <div className="absolute top-0 left-0 h-full bg-accent progress-fill" />
                        )}
                      </div>
                      <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all duration-300 ${currentStep >= 3 ? 'bg-accent text-accent-foreground step-glow' : 'bg-muted text-muted-foreground'
                      ...
                      <form onSubmit={handleBasicInfoSubmit} className="space-y-6" data-animate-child>
                        ...
                        <div className="p-4 rounded-lg bg-card/50 border border-accent/30 relative" data-animate-child>
                          <div className="flex items-start gap-3">
                            {/* Custom Checkbox */}
                            <div
                              className={`w-5 h-5 rounded-md border-2 transition-all duration-200 cursor-pointer mt-0.5 flex items-center justify-center hover:scale-110 ${formData.activateFreeDemo
