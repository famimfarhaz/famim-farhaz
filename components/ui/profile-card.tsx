  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl">
        <div className="pointer-events-none absolute inset-x-0 -bottom-10 top-[72%] rounded-[28px] bg-white/90 blur-0 shadow-[0_40px_80px_-16px_rgba(255,255,255,0.8)] z-0" />
          ...
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Link href="/contact">
                <Button
                  variant="secondary"
                  className="w-full h-12 justify-start gap-3 rounded-2xl bg-white/10 text-white hover:bg-white/15"
                >
